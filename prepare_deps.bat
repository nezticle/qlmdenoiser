...
cmake -GNinja -DCMAKE_BUILD_TYPE=Release -DTBB_ROOT=build/install -DISPC_EXECUTABLE=c:\ispc\bin\ispc.exe -DOIDN_STATIC_LIB=On -DOIDN_FILTER_RT=Off -DOIDN_APPS=Off -DCMAKE_INSTALL_PREFIX=build/install -S oidn -B build/oidn
